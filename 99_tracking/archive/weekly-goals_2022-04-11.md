...
- [x] letter for DSP re: Chelsea and Bess cost-share time
  ...
  - [ ] new IMLS budget form
  - [ ] personnel change justification
...
- [x] feedback on EDM, suwanee causal analysis
	- [x] record in reference stat
- [x] add search stats for metabolomics searches
- [x] add teaching stats for CURE class, Carpentries TTT, omics codeathon
- [x] add teaching stats for Fall 2021, Spring 2022
- [ ] faculty meeting minutes for April 01
- [ ] faculty meeting minutes for April 08
- [ ] faculty meeting minutes for April 15

### Omics codeathon
- [x] review git teaching materials
- [x] teach session
...
- [x] onsite interview (April 13)
- [ ] reminder for phone interview 

### Faculty Mentoring
- [x] personal identity wheel worksheet
- [x] pre-session work email
- [x] scenario discussion slides
- [x] identity wheel slides
- [x] takeaway slides
- [x] intro slides
- [ ] schedule informal chat before May 10 (maybe May 3?q)
