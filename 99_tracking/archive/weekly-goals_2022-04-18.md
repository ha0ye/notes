...
- [x] review and finish webpage updates
...
### Misc
- [x] annual eval
  - [x] 2022-2023 assignment with and without goals
  - [x] 2021-2022 assignment with progress
  - [x] goals 5/3
  - [x] updated CV
- [ ] faculty meeting minutes for April 01
- [x] faculty meeting minutes for April 08
- [x] faculty meeting minutes for April 15

### Metabolomics Software Reproducibility Paper
- [ ] feedback on paper

### ARCS Senior Director Search Committee
- [x] reminder for phone interview 

### Faculty Mentoring
- [x] schedule informal chat before May 10 (maybe May 3?)

### MLA Data Caucus
- [x] refine meeting agenda
- [x] go to Community Council annual Business meeting (April 19)

### MLA Talk
- [ ] prepare outline
- [ ] prepare slides (yellow-green background, dark grey, blue/lilac/pink?)
- [ ] 
