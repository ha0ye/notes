...
- [ ] standardize appearance? check in re: style guide
- [ ] extended guide work
...
- [ ] budget/personnel change for Perry and Chelsea
...
### Activity Reporter
- [x] set and check all header styles
- [x] read in data from UF templated tables
- [x] summary of grant funding ??
