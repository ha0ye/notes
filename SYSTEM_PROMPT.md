...
- **Collaborative folders allow direct edits.** `02_projects/`, `03_people/`, and `04_templates/` can be drafted, updated, and restructured — but never fabricate information the user hasn't provided.
...
- Follow the templates in `04_templates/` when creating new notes.
...
04_templates/    # Reusable scaffolds (collaborative)
