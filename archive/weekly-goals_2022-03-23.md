...
### Open Grants
- [x] agenda for UF Team check-in
- [ ] reach out to contacts for HBCU, MSI, TCU
- [x] letter for DSP re: Chelsea and Bess cost-share time
  - [x] follow-up reply to Ashley
  - [ ] DSP sent?
- [x] 2-page resume/CV from Laurie Taylor
- [x] contact Barbara Hood about lunch
- [x] email Hannah about coffee and snacks
- [ ] cost justification to Lori for coffee and snacks
- [x] feedback on paper draft
- [ ] timeline of environmental scan work
- [ ] agenda for advisory group meeting (May 19-20)
  + discussion items
...
- [x] faculty meeting minutes for March 11
- [x] journal club readings

### ARCS Senior Director Search Committee
- [x] review criteria chart
- [x] review initial applications
- [x] review DEI advocate responsibilities
- [x] review phone interview questions

### Faculty Mentoring
- [x] session assessment form
- [x] reschedule meeting with Twanna
- [x] create draft agenda for session 3
- [x] scaffolded slides
- [ ] personal identity wheel worksheet
- [ ] scenario discussion slides
- [ ] pre-session work email
- [ ] aggregate content from session 1 for discussion


### GMS 7877 Repro materials
- [x] update readings on Canvas
- [x] final check-in before class

### MLA Data Caucus
- [ ] coordinate Business meeting before MLA
  + add Peace Ossom-Williamson to agenda for NCDS update
- [x] poll for scheduling meeting
- [ ] go to Community Council annual Business meeting
...
- [x] update ARCS webpages
- [ ] review program description
- [x] update program description on UFRC website (removed!)
